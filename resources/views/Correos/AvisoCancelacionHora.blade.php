    ...
    <tr>
        <td style="padding: 10px 0 30px 0;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                ...
                <tr>
                    <td colspan="3">
                        <div>
                            <center>
                                <h1>
                                    AVISO DE CANCELACIÓN DE HORA DE ATENCIÓN
                                </h1>
                            </center>
                            <p><strong>¡HOLA!, {{ strtoupper($data['nombre_contacto']) }}.</strong> <br><br>
                                Queremos informarte que se ha cancelado la hora de atención por parte de:
                ...
                <tr>
                    <td><h3>Fecha y Hora Cancelada:</h3>
                        <p>{{ strtoupper($data['fecha_hora']) }}</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                        <center><h2>Llamar a +56 {{ strtoupper($data['fono']) }} para reservar nueva hora de atención.</h2>
                        </center>
                    </td>
                </tr>
                <br><br>
